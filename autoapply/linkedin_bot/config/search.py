...
search_location = ""               # Empty to search globally (US, UK, Canada, EMEA)
...
# LinkedIn experience levels (run filtered search)
# NO entry level - skip junior roles unless they have visa sponsorship
experience_level = ["Associate", "Mid-Senior level"]              # Associate, Mid-Senior only - no Entry level
job_type = ["Full-time"]                      # Full-time only
on_site = ["Remote", "Hybrid", "On-site"]                       # All options for visa sponsorship

companies = ["Turing", "Crossover", "Trilogy", "Deel", "Toptal", "Arc", "Remote", "GitLab", "Automattic"]                     # Remote-first companies that hire globally 
...
bad_words = ["US Citizen", "USA Citizen", "US Citizens only", "No C2C", "No Corp2Corp", "No Sponsorship", "Cannot Sponsor", "Security Clearance Required", "Clearance Required", "TS/SCI", "PHP", "Ruby on Rails", "Embedded", "CNC", "must be authorized to work", "without sponsorship"]                     # Skip jobs that won't sponsor
...
did_masters = False                 # Bachelor's degree

# Avoid applying to jobs if their required experience is above your current_experience. (Set value as -1 if you want to apply to all ignoring their required experience...)
current_experience = 5             # 5 years experience
##
